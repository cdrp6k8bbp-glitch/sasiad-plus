/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 9fbcc399b6d5624a445283c3247216bd)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	sasiad_plus_images: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	ALERT_EMAIL: "sasiadpluskontakt@wp.pl";
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	WORKER_SELF_REFERENCE: Fetcher /* sasiad-plus-staging */ | Service<typeof import("./custom-worker").default>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		WORKER_SELF_REFERENCE: Fetcher /* sasiad-plus-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALERT_EMAIL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
